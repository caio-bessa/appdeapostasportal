...
export interface ApiAppApp extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'apps';
    displayName: 'App';
    description: 'Aplicativos de apostas esportivas';
  };
  options: {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::app.app', 'name'> & Attribute.Required;
    ...
    pros: Attribute.Text;
    cons: Attribute.Text;
    bonus_info: Attribute.Text;
    minimum_deposit: Attribute.Decimal &
      Attribute.SetMinMax<
        {
          min: 0;
        },
        number
      >;
    payment_methods: Attribute.Text;
    license_info: Attribute.Text;
...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'articles';
    displayName: 'Article';
    description: 'Artigos e not\u00EDcias do portal';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    featured_image_url: Attribute.String;
    featured: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    author: Attribute.Relation<
      ...
      'api::author.author'
    >;
    related_apps: Attribute.Relation<
      'api::article.article',
      'manyToMany',
      'api::app.app'
    >;
    related_teams: Attribute.Relation<
      'api::article.article',
      'manyToMany',
      'api::team.team'
    >;
...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'authors';
    displayName: 'Author';
    description: 'Autores dos artigos';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Categorias para organizar conte\u00FAdo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'tags';
    displayName: 'Tag';
    description: 'Tags para categoriza\u00E7\u00E3o de conte\u00FAdo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTeamTeam extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'teams';
    displayName: 'Team';
    description: 'Times esportivos para tags em artigos';
  };
  options: {
    draftAndPublish: true;
  };
